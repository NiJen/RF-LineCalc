...
public class WireembeddedstriplineUI extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wireembeddedstripline_ui);
    ...
    public void BerechnungEmbeddedStriplineZL(View v){
        ...
        try {
            ...
            ZL=Wirestrip.MicrowireembeddedZL(h, d, ER);
